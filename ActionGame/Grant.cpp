...
Grant::Grant()
{
    x = 1000, y = 0, w = 40, h = 45, offset = 0,velocity = 0,xVel = 0, yVel = 0, currentAction = ACTION_RIGHT;
    cameraFocused = true;
    
    Animation* animationUp = new Animation;
    animationUp->image = RenderingUtils::load_image(GRANT_UP,255,255,255);
    ...
    animationDown->image = RenderingUtils::load_image(GRANT_DOWN,255,255,255);
    ...
    animationLeft->image = RenderingUtils::load_image(GRANT_LEFT,255,255,255);
    ...
    animationRight->image = RenderingUtils::load_image(GRANT_RIGHT,255,255,255);
    ...
    animationRightShoot->image = RenderingUtils::load_image(GRANT_RIGHT_SHOOT,255,255,255);
    ...
    animationUpShoot->image = RenderingUtils::load_image(GRANT_UP_SHOOT,255,255,255);
    ...
    animationLeftShoot->image = RenderingUtils::load_image(GRANT_LEFT_SHOOT,255,255,255);
    ...
    animationDownShoot->image = RenderingUtils::load_image(GRANT_DOWN_SHOOT,255,255,255);
